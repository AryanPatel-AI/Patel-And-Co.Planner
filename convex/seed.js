...
Healthy snacks and herbal teas included.`,
  ...
  // ── Bareilly Events ─────────────────────────────────────────────────────────
  {
    title: "Bareilly Tech Meetup — Web Dev & Open Source",
    description: `The Bareilly developer community gets together for an evening of talks, demos, and networking!

Topics this month:
- Building full-stack apps with Next.js 15
- Open source contribution — how to get started
- Career paths in tech from Tier-2 cities
- Live coding demo: REST vs GraphQL vs tRPC

Whether you're a student, working professional, or freelancer — all skill levels welcome. Bring your laptop!

Chai and snacks on us.`,
    category: "tech",
    tags: ["tech", "web-dev", "open-source", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Rohilkhand University Auditorium",
    address: "MJP Rohilkhand University, Pilibhit Bypass Road, Bareilly",
    capacity: 80,
    ticketType: "free",
    coverImage:
  ...
  {
    title: "Bareilly Utsav — Classical Music & Dance Evening",
    description: `A celebration of India's rich classical heritage, right in the heart of Bareilly!

Performances include:
- Kathak dance by local students of Guru Birju Maharaj's lineage
- Hindustani classical vocal by award-winning artists
- Tabla and Sarangi jugalbandi
- Folk music of Rohilkhand region

The evening concludes with an open jam session where audience members are invited to perform.

A cultural night not to be missed — bring your family!`,
    category: "music",
    tags: ["music", "classical", "cultural", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Town Hall, Bareilly",
    address: "Shastri Nagar, Civil Lines, Bareilly, Uttar Pradesh 243001",
    capacity: 200,
    ticketType: "paid",
    ticketPrice: 150,
    coverImage:
  ...
  {
    title: "Bareilly Inter-College Cricket Cup 2026",
    description: `The most awaited college cricket tournament in Bareilly is here!

Format:
- 16 college teams, T20 format
- League stage followed by knockout rounds
- Professional umpires & digital scoring
- Live commentary by RJ Sparsh

Prizes:
- Winner: ₹25,000 + Rolling Trophy
- Runner-up: ₹12,000
- Best Batsman, Best Bowler, Best Fielder awards

Register your college team (playing 11 + 4 substitutes). Individual entries also accepted — we'll form teams.

Refreshments available throughout. Wear your college colours!`,
    category: "sports",
    tags: ["sports", "cricket", "college", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Gandhi Udyan Cricket Ground",
    address: "Gandhi Udyan, Bareilly, Uttar Pradesh 243001",
    capacity: 250,
    ticketType: "paid",
    ticketPrice: 100,
    coverImage:
  ...
  {
    title: "Rohilkhand Food Festival — Flavours of UP",
    description: `A grand celebration of Uttar Pradesh's legendary cuisine!

What's on offer:
- 30+ stalls featuring authentic UP dishes
- Live tawa roti, biryani, and kebab stations
- Special Bareilly specialty: Dalmoth and Bichiya
- Dessert zone: Mawa jalebi, rabri, and kulfi
- Cook-off competition with cash prizes
- Heritage food walk with a local historian

Family-friendly event. Entry gives you access to all areas — pay per dish at stalls.

Live folk music in the background all evening.`,
    category: "food",
    tags: ["food", "culture", "street-food", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Deen Dayal Upadhyaya Park",
    address: "DDU Park, Subhash Nagar, Bareilly, Uttar Pradesh 243003",
    capacity: 500,
    ticketType: "paid",
    ticketPrice: 50,
    coverImage:
  ...
  {
    title: "Digital Literacy & AI Workshop for Students",
    description: `Empowering the youth of Bareilly with the skills of tomorrow!

This free workshop covers:
- What is Artificial Intelligence? (no jargon)
- Using AI tools: ChatGPT, Gemini, image generators
- Fact-checking in the age of deepfakes
- Building a simple chatbot — live demo
- Career opportunities in tech from Tier-2 cities
- Q&A with working professionals from Bareilly

Targeted at Class 9–12 students and first-year college students. No prior tech knowledge needed.

Certificates of participation provided. Bring your smartphone or laptop.`,
    category: "education",
    tags: ["education", "ai", "students", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Bareilly College Seminar Hall",
    address: "Bareilly College, Bareilly, Uttar Pradesh 243005",
    capacity: 120,
    ticketType: "free",
    coverImage:
      "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&q=80",
  ...
  {
    title: "Bareilly Green Drive — Tree Plantation Walk",
    description: `Join us in making Bareilly greener, one sapling at a time!

Activity plan:
- Group tree plantation across 3 city parks
- Talk on urban tree cover and air quality
- DIY compost and vermicompost demo
- City cycling tour to plantation sites
- Interaction with the Forest Department

Over 500 saplings to be planted by volunteers. All materials provided. Wear comfortable clothes and sturdy footwear.

Certificate and badge for all volunteers. Refreshments included.`,
    category: "community",
    tags: ["community", "environment", "volunteer", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Triveni Nagar Park",
    address: "Triveni Nagar, Bareilly, Uttar Pradesh 243122",
    capacity: 150,
    ticketType: "free",
    coverImage:
  ...
  {
    title: "Morning Yoga at the Ramganga Riverfront",
    description: `Start your Sunday with peace, fresh air, and the gentle sound of the Ramganga!

Session details:
- 60-minute Hatha & Vinyasa flow
- 20-minute guided breathwork (Pranayama)
- 10-minute meditation and grounding
- Sunset walk along the riverfront afterwards

Our certified instructor welcomes all levels — complete beginners to seasoned practitioners. Modifications provided throughout.

Yoga mats available on loan (₹50 deposit). Wear light, breathable clothing. Water bottle recommended.`,
    category: "health",
    tags: ["health", "yoga", "wellness", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Ramganga Riverfront",
    address: "Ramganga Ghat, Bareilly, Uttar Pradesh 243001",
    capacity: 60,
    ticketType: "paid",
    ticketPrice: 99,
    coverImage:
  ...
  {
    title: "Bareilly SME Summit — Grow Your Local Business",
    description: `A business summit designed for small and medium entrepreneurs of Bareilly and the Rohilkhand region!

Sessions include:
- GST & tax compliance simplified (CA panel)
- Taking your local business online — e-commerce basics
- Getting government MSME benefits and loans
- Social media marketing on ₹0 budget
- Inspiring story: Bareilly startup that went national

Followed by networking lunch and a business card exchange session.

Ideal for shop owners, manufacturers, traders, freelancers, and aspiring entrepreneurs.

Lunch included. Limited seats — register early.`,
    category: "business",
    tags: ["business", "sme", "entrepreneurship", "bareilly"],
    city: "Bareilly",
    state: "Uttar Pradesh",
    venue: "Hotel Ritz Residency",
